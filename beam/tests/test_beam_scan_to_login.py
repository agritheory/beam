...
from beam.tests.playwright_utils import get_playwright_base_url, use_current_db_transaction
...
def logout(page):
	page.goto(f"{get_playwright_base_url()}/api/method/logout")
...
def test_scan_to_login_success_all_users(page):
	...
	page.goto(f"{get_playwright_base_url()}/login")
	page.wait_for_load_state("networkidle")

	expect(page).to_have_url(get_playwright_base_url() + "/login#login")
	...
	expect(page).to_have_url(get_playwright_base_url() + "/beam#/")
...
def test_scan_to_login_invalid_barcode(page):
	...
	# Navigate to login page
	page.goto(f"{get_playwright_base_url()}/login#login")
	page.wait_for_load_state("networkidle")
